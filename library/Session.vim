...
set shortmess=aoO
badd +4 ~/workspace/android-times-square/library/Makefile
silent! argdel *
...
setlocal tabstop=4
setlocal tags=~/workspace/android-times-square/.git/make.tags,~/workspace/android-times-square/.git/tags,./tags,tags
